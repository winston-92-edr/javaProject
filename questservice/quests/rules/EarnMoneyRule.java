...
public class EarnMoneyRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(EarnMoneyRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at EarnMoneyRule>> " + e.getMessage());
        }
    }
}
