...
public class WonGameDoubleRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(WonGameDoubleRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at WonGameDoubleRule>> " + e.getMessage());
        }
    }
}
