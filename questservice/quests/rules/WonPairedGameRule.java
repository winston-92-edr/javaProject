...
public class WonPairedGameRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(WonPairedGameRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at WonPairedGameRule>> " + e.getMessage());
        }
    }
}
