...
public class FinishClassicGameRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(FinishClassicGameRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at FinishClassicGameRule>> "+e.getMessage());
        }
    }
}
