...
public class WonSingleGameRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(WonSingleGameRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at WonSingleGameRule>> " + e.getMessage());
        }
    }
}
