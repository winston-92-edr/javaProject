...
public class WonSingleGameGainXpRule implements QuestRule{
    Logger logger = LoggerFactory.getLogger(WonSingleGameGainXpRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
            ...
            logger.error("Error at WonSingleGameGainXpRule>> " + e.getMessage());
        }
    }
}
