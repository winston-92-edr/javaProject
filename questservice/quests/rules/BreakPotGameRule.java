...
public class BreakPotGameRule implements QuestRule {
    private static Logger logger = LoggerFactory.getLogger(BreakPotGameRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at BreakPotGameRule>> " + e.getMessage());
        }
    }
}
