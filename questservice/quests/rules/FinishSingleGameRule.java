...
public class FinishSingleGameRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(FinishSingleGameRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at FinishSingleGameRule>> " + e.getMessage());
        }
    }
}
