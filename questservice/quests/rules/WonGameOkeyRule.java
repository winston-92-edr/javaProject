...
public class WonGameOkeyRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(WonGameOkeyRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at WonGameOkeyRule>> " + e.getMessage());
        }
    }
}
