...
public class WonClassicGameRule implements QuestRule {
    Logger logger = LoggerFactory.getLogger(WonClassicGameRule.class);
    ...
    public void check(QuestModel model, String info, int day) {
        try {
           ...
           if (questController.invalidQuestDay(model)) return;
            ...
            logger.error("Error at WonClassicGameRule>> "+e.getMessage());
        }
    }
}
