...
public class QuestRequest extends ObserverRunnable {
    ProxyUser user;
    NetworkMessage request;
    String id;

    public QuestRequest() {
        this.id = "QuestRequest_" + System.currentTimeMillis();
    }
    ...
    public void run() {
        try {
//            Node node = UserController.getInstance().getNodeController().getQuestNode();
//            if (node != null) {
