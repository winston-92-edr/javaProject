...
public class IncrementWonGameTournament implements Callable {
    Logger logger = LoggerFactory.getLogger(IncrementWonGameTournament.class);

    String userId;
    int tournamentId;

    public IncrementWonGameTournament(String userId, int tournamentId) {
        this.userId = userId;
    ...
    public Object call() throws Exception {
        ...
        try (DSLContext context = DSL.using(dataSource, SQLDialect.MYSQL)){
            context.update(TOURNAMENT_HISTORY)
                    .set(TOURNAMENT_HISTORY.WON_GAME, TOURNAMENT_HISTORY.WON_GAME.add(1))
