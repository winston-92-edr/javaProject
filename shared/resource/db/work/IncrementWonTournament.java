...
public class IncrementWonTournament implements Callable {
    Logger logger = LoggerFactory.getLogger(IncrementWonTournament.class);

    String userId;
    int tournamentId;

    public IncrementWonTournament(String userId, int tournamentId) {
        this.userId = userId;
