...
public class IncrementTotalGameTournament implements Callable {
    Logger logger = LoggerFactory.getLogger(IncrementTotalGameTournament.class);

    String userId;
    int tournamentId;

    public IncrementTotalGameTournament(String userId, int tournamentId) {
        this.userId = userId;
    ...
    public Object call() throws Exception {
        ...
        try (DSLContext context = DSL.using(dataSource, SQLDialect.MYSQL)){
            context.update(TOURNAMENT_HISTORY)
                    .set(TOURNAMENT_HISTORY.TOTAL_GAME, TOURNAMENT_HISTORY.TOTAL_GAME.add(1))
